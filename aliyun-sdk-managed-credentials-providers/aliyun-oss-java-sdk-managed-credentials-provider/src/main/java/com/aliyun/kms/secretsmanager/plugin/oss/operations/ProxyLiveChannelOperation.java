...
public class ProxyLiveChannelOperation extends LiveChannelOperation implements ProxyOSSOperation {
    ...
    public ProxyLiveChannelOperation(ServiceClient client, CredentialsProvider credsProvider, String secretName, AKExpireHandler akExpireHandler, AliyunSDKSecretsManagerPlugin secretsManagerPlugin) {
