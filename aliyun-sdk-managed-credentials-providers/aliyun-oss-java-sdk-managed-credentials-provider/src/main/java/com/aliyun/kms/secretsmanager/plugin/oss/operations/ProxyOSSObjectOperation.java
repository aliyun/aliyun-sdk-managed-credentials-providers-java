...
public class ProxyOSSObjectOperation extends OSSObjectOperation implements ProxyOSSOperation {
    ...
    public ProxyOSSObjectOperation(ServiceClient client, CredentialsProvider credsProvider, String secretName, AKExpireHandler akExpireHandler, AliyunSDKSecretsManagerPlugin secretsManagerPlugin) {
