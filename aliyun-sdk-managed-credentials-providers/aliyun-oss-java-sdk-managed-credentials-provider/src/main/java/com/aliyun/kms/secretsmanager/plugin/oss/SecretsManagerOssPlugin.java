    ...
    class ProxyOSSClient extends OSSClient {
        ...
        private void initOssOptions() {
            ...
            try {
                ...
                ProxyOSSObjectOperation proxyOSSObjectOperation = new ProxyOSSObjectOperation((ServiceClient) serviceClient, this.getCredentialsProvider(), secretName, akExpireHandler, secretsManagerPlugin);
                ...
                ProxyOSSMultipartOperation proxyOSSMultipartOperation = new ProxyOSSMultipartOperation((ServiceClient) serviceClient, this.getCredentialsProvider(), secretName, akExpireHandler, secretsManagerPlugin);
                ...
                uploadOperationField.set(this, new OSSUploadOperation(proxyOSSMultipartOperation));
                ...
                downloadOperationField.set(this, new OSSDownloadOperation(proxyOSSObjectOperation));
