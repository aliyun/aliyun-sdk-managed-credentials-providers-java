...
public class ProxyOSSMultipartOperation extends OSSMultipartOperation implements ProxyOSSOperation {
    ...
    public ProxyOSSMultipartOperation(ServiceClient client, CredentialsProvider credsProvider, String secretName, AKExpireHandler akExpireHandler, AliyunSDKSecretsManagerPlugin secretsManagerPlugin) {
