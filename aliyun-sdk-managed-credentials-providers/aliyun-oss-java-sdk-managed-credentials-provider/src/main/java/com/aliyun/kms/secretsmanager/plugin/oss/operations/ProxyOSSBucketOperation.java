...
public class ProxyOSSBucketOperation extends OSSBucketOperation implements ProxyOSSOperation {
    ...
    public ProxyOSSBucketOperation(ServiceClient client, CredentialsProvider credsProvider, String secretName, AKExpireHandler akExpireHandler, AliyunSDKSecretsManagerPlugin secretsManagerPlugin) {
